...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .action-icon i{ font-size: 1.125rem; }
    ...
    @media (max-width: 992px){
      .navbar-menu, .navbar-search, .navbar-actions{ display:none; }
    ...
    @media (max-width: 768px){
      .footer-wrapper{ flex-direction: column; text-align:center; gap: 12px; }
...
<body>
    ...
    <div class="container-fluid px-3 px-md-4">
      <div class="navbar-wrapper">
        ...
        <ul class="navbar-menu">
          ...
          <li class="nav-item">
            <a href="{{ route('user.setoran.index') }}" class="nav-link {{ request()->routeIs('user.setoran.index') ? 'active' : '' }}">
          ...
          <div class="user-dropdown">
            ...
            <div class="user-dropdown-menu">
              ...
              <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="user-dropdown-item text-start" style="border:none;background:none;cursor:pointer;">
  ...
  <div class="mobile-menu" id="mobileMenu">
    ...
    <nav class="mobile-nav">
      ...
      <a href="{{ route('user.setoran.create') }}" class="nav-link {{ request()->routeIs('user.setoran.create') ? 'active' : '' }}">
